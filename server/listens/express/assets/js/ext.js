class Ext {
    ...
    static get aacceptPostMessages(){return ['toggleExt', 'location', 'openNotif', 'closeNotif', 'linkTo', 'getClientMetas']};
    ...
    constructor(refusedFrame = false){
        ...
        if(!noBootFlg){
            ...
            this.loadExt = this.loadExt.bind(this);
            ...
            this.iframe.addEventListener( "load", this.loadExt );
...
//            document.querySelector("#talknTest").appendChild(this.iframe);
    ...
    loadExt(e){
        ...
        this.postMessage("bootExtension", {extensionMode: Ext.MODE});
    }
