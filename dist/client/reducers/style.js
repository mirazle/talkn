...
exports.default = (state = {}, action) => {
    switch (action.type) {
        case "SERVER_TO_CLIENT[EMIT]:connectionServer":
        ...
        case "ON_CLICK_TO_TIMELINE_THREAD":
            return Object.assign(Object.assign({}, state), { posts: Object.assign(Object.assign({}, state.posts), { self: Posts_1.default.getSelf(action) }), board: Object.assign(Object.assign({}, state.board), { self: Object.assign(Object.assign({}, state.board.self), { height: Board_1.default.getSelfHeight(action.app) }), menuLiChild: Object.assign(Object.assign({}, state.menuLiChild), { color: App_1.default.isActiveMultistream(action.app, "reducer") ? Board_1.default.activeColor : Board_1.default.unactiveColor }), menuLiLinks: Object.assign(Object.assign({}, state.menuLiLinks), { color: Board_1.default.unactiveColor }) }), video: Object.assign(Object.assign({}, state.video), { self: Video_1.default.getSelf(action) }), audio: Object.assign(Object.assign({}, state.audio), { self: Audio_1.default.getSelf(action) }) });
