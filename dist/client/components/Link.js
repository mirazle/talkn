...
class Link extends TalknComponent_1.default {
    ...
    getEvents(isActive) {
        ...
        if (!isActive) {
            return {
                ...
                onMouseOver: () => {
                    this.setState({
                        style: Object.assign(Object.assign({}, style), { background: Link_1.default.activeBgColor })
                    });
                },
                onMouseLeave: () => {
                    this.setState({
                        style: Object.assign(Object.assign({}, style), { background: Link_1.default.unactiveBgColor })
                    });
                }
            };
        }
    ...
    render() {
        ...
        const background = MenuIndexList_1.default.getDispRankBackground(0);
        const width = Board_1.default.tuneSize;
        if (isActive) {
            return (react_1.default.createElement("li", { style: this.props.state.style.link.tuneLi },
                react_1.default.createElement("span", { style: Object.assign(Object.assign({}, upperRankWrap), { background, width }) },
