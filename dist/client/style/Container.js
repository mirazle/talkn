...
class Container {
    ...
    static get borderRGB() {
        return index_1.default.mono220RGB;
    }
    static get border() {
    ...
    static getSelf({ app, ui, bootOption, type }) {
        const overflow = ui.extensionMode === Ui_1.default.extensionModeExtBottomLabel ? "hidden" : "inherit";
        let borderRadius = "0px";
        if (bootOption && bootOption["border-radius"]) {
            borderRadius = bootOption["border-radius"];
        }
        else {
            if (borderRadius === "0px" && ui.extensionMode === Ui_1.default.extensionModeExtModalLabel) {
                borderRadius = "3px";
            }
        }
    ...
    static getMultistreamIconWrapTop({ app, ui }) {
        if (ui.extensionMode === Ui_1.default.extensionModeExtBottomLabel) {
            return Header_1.default.headerHeight + Container.multistreamWrapDefaultTop + "px";
        }
    ...
    static getNewPost({ app, ui }) {
        ...
        delete styles.top;
        return Object.assign(Object.assign({}, styles), { display, zIndex: "1", margin: "0px auto", bottom: `-${Container.notifHeight}px`, transition: Container.getTransition({ app, ui }) });
    }
    ...
    static getLinkLabel({ app, ui }) {
        const top = Header_1.default.headerHeight + "px";
