...
class Schema {
            ...
            if (error === null) {
                Object.defineProperty(this, key, {
                    ...
                    set: _value => {
                        ...
                        if (error === null) {
                            value = _value;
                            return Object.assign(Object.assign({}, this), { [key]: value });
                        }
                        else {
    ...
    merge(params = {}, immutable = true) {
        try {
            ...
            if (objKeys.length > 0) {
                let mergedObj = Object.assign({}, this);
                objKeys.forEach(key => {
                ...
                if (paramsType === "Array") {
                    ...
                    return immutable
                        ? new this.constructor(mergedObj)
                        : mergedObj;
                }
                else {
                    if (immutable) {
                        return new this.constructor(mergedObj);
                    }
                    else {
                        return mergedObj;
                    }
