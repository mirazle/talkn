...
class Favicon {
    ...
    static get defaultFaviconPath() {
        return `${Sequence_1.default.HTTPS_PROTOCOL}${conf_1.default.assetsPath}${Favicon.defaultFaviconFileName}${Favicon.extension}`;
    }
                ...
                if (!error && response && response.statusCode === 200) {
                    ...
                    if (response.headers["content-type"].indexOf("image") === 0) {
                        ...
                        if (response.headers["content-length"] !== "0") {
                            if (log)
                                console.log("C");
                            resolve(Object.assign(Object.assign({}, faviconData), { faviconBinary }));
                            return true;
                        }
                    }
                }
