...
exports.default = Object.assign(Object.assign({ ch: { type: String, default: "/" }, chs: { type: [String], default: ["/"] }, findType: { type: String, default: "" }, hasSlash: { type: Boolean, default: false }, host: { type: String, default: "" }, layer: { type: Number, default: 0 }, title: { type: String, default: "talkn" }, favicon: { type: String, default: Favicon_1.default.defaultFaviconPath }, faviconType: {
        type: String,
        default: Favicon_1.default.defaultFaviconData.faviconType
    }, postCnt: { type: Number, default: 0 }, multiPostCnt: { type: Number, default: 0 }, watchCnt: { type: Number, default: 1, min: 0 } }, html), { lastPost: Posts_1.default, like: { type: Number, default: 0 }, emotions: {
        plain,
        russell,
        russellSimple
    }, createTime: { type: Date, default: Date }, updateTime: { type: Date, default: Date } });
