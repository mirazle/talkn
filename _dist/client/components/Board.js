...
class Board extends TalknComponent_1.default {
    ...
    handleOnTransitionEnd(e) {
        ...
        if (exeTransitionEnd) {
            ...
            this.setState(Object.assign(Object.assign({}, updateState), { exeTransitionEnd: false }));
        }
    }
    ...
    renderLiChild() {
        ...
        const ThunderIcon = Icon_1.default.getThunder(Icon_2.default.getThunder(state));
