...
class DetailModal extends TalknComponent_1.default {
    render() {
        this.props.clientState.style.detail.self = this.props.clientState.style.detail[`self${Detail_2.default.detailModalSelfKey}`];
