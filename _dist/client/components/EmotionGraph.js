...
class EmotionGraph extends TalknComponent_1.default {
    constructor(props) {
        ...
        this.state = {
            ...
            data: {
                ...
                datasets: [Object.assign(Object.assign({}, EmotionGraph_1.default.datasetsBase), { data })]
            },
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.state.app.actioned === "SERVER_TO_CLIENT[BROADCAST]:post" ||
    ...
    render() {
        ...
        if (data && data.datasets && data.datasets.length > 0 && data.datasets[0].data.length > 0) {
            return (react_1.default.createElement("div", { style: style.emotionGraph.self },
