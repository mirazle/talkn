...
class LockMenu {
    ...
    static getCommonLayout({ app, ui }) {
        const layout = {
            ...
            top: `calc( 100% + ${Container_1.default.getBlockSize({ app, ui })}px)`,
            left: "5%",
            flexFlow: "column",
    ...
    static getCommonTransform({ app, ui }) {
        return ui.openLockMenu === Ui_1.default.openLockMenuLabelNo ? "translate3d(0px, 0px, 0px)" : `translate3d(0px, -75vh, 0px)`;
    }
