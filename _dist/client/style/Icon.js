...
class Icon {
    ...
    static getMargin({ app, ui }) {
        return ui.screenMode === Ui_1.default.screenModeSmallLabel ? Icon.smallMargin : Icon.largeMargin;
    }
    ...
    static getChromeExtension({ app, ui }, option = {}) {
        ...
        return index_1.default.get({
            layout: index_1.default.getLayoutBlock({
                ...
                backgroundImage: `url(https://${conf_1.default.assetsImgPath}${image})`,
                backgroundRepeat: "no-repeat",
                backgroundColor: Container_1.default.silverRGBA,
            }),
            content: index_1.default.getContentBase({
                cursor,
            }),
    ...
    static getDetail({ app, ui }) {
        const margin = ui.screenMode === Ui_1.default.screenModeSmallLabel ? "0" : "1px auto";
        const div = index_1.default.get({
            layout: index_1.default.getLayoutInlineFlex({
                width: "54px",
                height: "100%",
                borderRadius: "100px",
                margin,
        ...
        const mekuri = index_1.default.get({
            layout: {
                ...
                height: 0,
                borderRadius: 0,
                borderTop: `4px solid ${Container_1.default.whiteRGB}`,
                borderLeft: `4px solid ${Container_1.default.whiteRGB}`,
                borderRight: `4px solid ${Container_1.default.reliefRGB}`,
    ...
    static getLiveCnt({ app, ui }) {
        const div = index_1.default.get({
            layout: index_1.default.getLayoutInlineBlock({
                width: "26px",
                height: "26px",
                background: `rgba(${Container_1.default.themeRGBString}, 0.85)`,
                borderRadius: "26px",
            }),
            content: index_1.default.getContentBase({
                fontSize: "0.7em",
    ...
    static getStampLabel({ app, ui }) {
        ...
        let labelLayout = {
            left: Ui_1.default.screenModeSmallLabel === ui.screenMode ? "-12%" : "-9%",
            color: Container_1.default.whiteRGB,
        ...
        if (!ui.isBubblePost) {
            ...
            labelLayout.left = Ui_1.default.screenModeSmallLabel === ui.screenMode ? "30%" : "27%";
            labelLayout.background = "none";
            labelLayout.borderRadius = Container_1.default.radius;
            labelLayout.justifyContent = "flex-start";
            labelContent.color = Container_1.default.fontBaseRGB;
        ...
        const label = index_1.default.get({
            layout: index_1.default.getLayoutFlex({
                position: "relative",
                width: "120px",
                height: "inherit",
