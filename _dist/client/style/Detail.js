...
class Detail {
    ...
    static getDetailRightSelf({ app, ui }) {
        const layout = index_1.default.getLayoutBlock({
            ...
            height: `calc( 100% - ${Container_1.default.getBlockSize({ app, ui })}px )`,
            WebkitOverflowScrolling: "touch",
            overflow: "hidden",
            margin: `${Container_1.default.getBlockSize({ app, ui })}px 0px 0px 0px`,
            zIndex: 0,
        });
        const content = index_1.default.getContentBase();
        const animation = index_1.default.getAnimationBase({
    ...
    static getHeader({ app, ui }) {
        const layout = index_1.default.getLayoutFlex({
            ...
            maxHeight: `${Container_1.default.getBlockSize({ app, ui })}px`,
            borderBottom: `1px solid ${Container_1.default.borderRGB}`,
    ...
    static getHeaderP({ app, ui }) {
        const layout = index_1.default.getLayoutFlex({
            width: "100%",
            height: "100%",
            maxHeight: Container_1.default.getBlockSize({ app, ui }),
        });
        const content = index_1.default.getContentBase({
