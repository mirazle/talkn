...
const index_1 = __importDefault(require("./Menu/index"));
const MenuIndexList_1 = __importDefault(require("./Menu/MenuIndexList"));
...
class Style {
    constructor(params) {
        ...
        const menuIndex = new index_1.default(params);
        const menuIndexList = new MenuIndexList_1.default(params);
    ...
    static get(styles = { layout: {}, content: {}, animation: {} }) {
        return Object.assign(Object.assign(Object.assign({}, styles.layout), styles.content), styles.animation);
    }
    static getLayoutBase(style = {}) {
        ...
        return Object.assign(Object.assign({}, baseLayout), style);
    }
    static getLayoutFlex(style = {}) {
        ...
        return Object.assign(Object.assign({}, blockLayout), style);
    }
    ...
    static getLayoutInlineBlock(style = {}) {
        ...
        return Object.assign(Object.assign({}, inlineBlockLayout), style);
    }
    ...
    static getContentBase(style = {}) {
        ...
        return Object.assign(Object.assign(Object.assign({}, contentBase), fontBase), style);
    }
    static getFontBase(style = {}) {
        ...
        return Object.assign(Object.assign({}, fontBase), style);
    }
    static getAnimationBase(style = {}) {
        ...
        return Object.assign(Object.assign({}, animationBase), style);
    }
