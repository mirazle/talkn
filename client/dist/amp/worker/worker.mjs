    ...
    class Element extends ParentNode {
      ...
      removeAttributeNS(namespaceURI, name) {
        ...
        if (index >= 0) {
          ...
          , this[7
          /* index */
          ], store(name), store(namespaceURI), 0]);
        }
      }
      /**
      ...
      getBoundingClientRectAsync() {
        ...
        return new Promise(resolve => {
          ...
          if (!this.ownerDocument.addGlobalEventListener || !this.isConnected) {
            ...
            transfer$2(this.ownerDocument, [5
            /* GET_BOUNDING_CLIENT_RECT */
            , this[7
            /* index */
            ]]);
    ...
    */
    ...
    class Document extends Element {
      constructor(global) {
        ...
        this[_a$c] = true; // Element uppercases its nodeName, but Document doesn't.
     ...
     * limitations under the License.
     */
    function initialize(document, strings, hydrateableNode, cssKeys, globalEventHandlerKeys, [innerWidth, innerHeight], localStorageData, sessionStorageData) {
      appendKeys(cssKeys);
