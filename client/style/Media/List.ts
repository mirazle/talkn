...
export default class List {
  ...
  static get marginLeft() {
    return List.marginBase * List.marginLeftMag;
  }
  ...
  static getSelfBorderRadius(app: any) {
    return Board.getSelfBackground(app);
  }

  static getSelfTop(app: any) {
  ...
  static getSelfHeight(app: any) {
    return Board.getSelfHeight(app);
  }

  static getSelfRight(app: any) {
    let right = "0px";
    switch (app.screenMode) {
      case App.screenModeSmallLabel:
        right = "0px";
